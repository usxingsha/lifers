...
def main() -> int:
    ...
    from lifers_brain.model_names import resolve_existing_weight_file
    ...
    try:
        ...
        from lifers_brain.runtime_mode import resolve_runtime
        ...
        from lifers_brain.openclaw_compat import summary_for_verify, verify_upstream_drift
