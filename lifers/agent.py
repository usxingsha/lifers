...
from lifers.instincts import load_instinct_state, sync_prev_user_ts, tick_instincts_end, tick_instincts_start
from lifers.inference_pipeline import log_inference
from lifers.health import emit_health_report
from lifers.llm_ops_context import format_llm_ops_context
from lifers.local_brain import (
    AgentConfig,
    LocalBrain,
...
from lifers.memory import LongTermMemory, MemoryItem, Scratchpad, SessionMemory
from lifers.model_names import canonical_brain_model
from lifers.npc_engine import NpcEngine
from lifers.openclaw_compat import format_rs_integrated_layout_hint, integration_context_for_agent
from lifers.organ_system import format_organ_system_context
from lifers.physiology_sim import update_physiology_and_format
from lifers.planner import Planner
from lifers.runtime_mode import resolve_runtime, runtime_label_from_role, runtime_system_line
from lifers.speed_env import local_lm_max_chars as speed_local_lm_max_chars
from lifers.stack_env import load_stack
from lifers.tools import ToolCall, ToolRegistry, ToolResult, build_default_registry
...
class LifersAgent:
    ...
    def _remote_quick_chat_attempt(self, user_line: str) -> Optional[str]:
        ...
        if not remote_on:
            return None
        from lifers.openai_compat_chat import _is_localhost_url, chat_completion_text, resolve_api_key
    ...
    def _inject_realtime_spacetime_context(self, stack: Dict[str, Any]) -> None:
        from datetime import datetime
        from lifers.realtime_anchor import geo_context_line
