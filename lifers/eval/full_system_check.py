...
def check_memory() -> None:
    from lifers.memory import LongTermMemory, MemoryItem
    import time
...
def check_safe_file() -> None:
    from lifers.safe_file_backup import commit_journal, restore_from_hint, safe_replace_file_text
...
def check_tools_dry_run() -> None:
    from lifers.tools import ToolCall, build_default_registry
...
def check_steward_math() -> None:
    from lifers.memory import LongTermMemory, MemoryItem
    from lifers.steward import _resolve_global_forget_params
    import time
